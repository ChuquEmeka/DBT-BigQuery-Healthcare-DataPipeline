-- back compat for old kwarg name
    ...
    merge into `healthcare-data-project-442109`.`dev_healthcare_data`.`patient_demographics` as DBT_INTERNAL_DEST
        using (
...
ORDER BY
    ...
    when not matched then insert
        (`patient_id`, `age_group`, `gender`, `insurance_type`, `patient_count`)
    values
        (`patient_id`, `age_group`, `gender`, `insurance_type`, `patient_count`)
